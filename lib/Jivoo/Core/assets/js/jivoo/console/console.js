var JIVOO = (function(parent, $, Cookies) {
  ...
  function Tool(id, name, createContent, url) {
    this.id = id;
    this.name = name;
  ...
  my.addTool = function(id, name, contentFunction, url) {
    var tool = new Tool(id, name, contentFunction, url);
    toolQueue.push(tool);
    updateTools();
    return tool;
  };
...
$(function() {
  ...
  JIVOO.devbar.addTool('jivoo-request', 'Request', function ($content) {
    var $log = $('<div class="jivoo-console-log">');
